...
interface NativeModuleInterface {
  ...
  ubrn_uniffi_breez_sdk_common_fn_clone_fiatservice(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus
  ): bigint;
  ubrn_uniffi_breez_sdk_common_fn_free_fiatservice(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus
  ): void;
  ubrn_uniffi_breez_sdk_common_fn_method_fiatservice_fetch_fiat_currencies(
    ptr: bigint
  ): bigint;
  ubrn_uniffi_breez_sdk_common_fn_method_fiatservice_fetch_fiat_rates(
    ptr: bigint
  ): bigint;
  ...
  ubrn_uniffi_breez_sdk_common_fn_clone_syncstorage(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus
  ): bigint;
  ubrn_uniffi_breez_sdk_common_fn_free_syncstorage(
    ptr: bigint,
    uniffi_out_err: UniffiRustCallStatus
  ): void;
  ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_add_outgoing_change(
    ptr: bigint,
    record: Uint8Array
  ): bigint;
  ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_complete_outgoing_sync(
    ptr: bigint,
    record: Uint8Array
  ): bigint;
  ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_get_pending_outgoing_changes(
    ptr: bigint,
    limit: number
  ): bigint;
  ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_get_last_revision(
    ptr: bigint
  ): bigint;
  ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_insert_incoming_records(
    ptr: bigint,
    records: Uint8Array
  ): bigint;
  ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_delete_incoming_record(
    ptr: bigint,
    record: Uint8Array
  ): bigint;
  ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_rebase_pending_outgoing_records(
    ptr: bigint,
    revision: bigint
  ): bigint;
  ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_get_incoming_records(
    ptr: bigint,
    limit: number
  ): bigint;
  ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_get_latest_outgoing_change(
    ptr: bigint
  ): bigint;
  ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_update_record_from_incoming(
    ptr: bigint,
    record: Uint8Array
  ): bigint;
  ...
  ubrn_uniffi_breez_sdk_common_fn_init_callback_vtable_fiatservice(
  ...
  ubrn_uniffi_breez_sdk_common_fn_init_callback_vtable_syncstorage(
