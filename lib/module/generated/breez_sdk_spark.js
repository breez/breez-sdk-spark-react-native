...
export function defaultSyncStorage(dataDir) /*throws*/{
  return FfiConverterTypeSyncStorage.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeSdkError.lift.bind(FfiConverterTypeSdkError), /*caller:*/callStatus => {
    return nativeModule().ubrn_uniffi_breez_sdk_spark_fn_func_default_sync_storage(FfiConverterString.lower(dataDir), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
...
function uniffiEnsureInitialized() {
  ...
  if (nativeModule().ubrn_uniffi_breez_sdk_spark_checksum_func_default_sync_storage() !== 62413) {
    throw new UniffiInternalError.ApiChecksumMismatch('uniffi_breez_sdk_spark_checksum_func_default_sync_storage');
  }
  ...
  if (nativeModule().ubrn_uniffi_breez_sdk_spark_checksum_method_sdkbuilder_with_real_time_sync_storage() !== 36431) {
