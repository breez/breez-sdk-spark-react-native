 ...
 */export function newConnectionManager(connectionsPerOperator){return FfiConverterTypeConnectionManager.lift(uniffiCaller.rustCall(/*caller:*/callStatus=>{return nativeModule().ubrn_uniffi_breez_sdk_spark_fn_func_new_connection_manager(FfiConverterOptionalUInt32.lower(connectionsPerOperator),callStatus);},/*liftString:*/FfiConverterString.lift));}/**
 ...
 */export function newRestChainService(url,network,apiType,credentials){return FfiConverterTypeBitcoinChainService.lift(uniffiCaller.rustCall(/*caller:*/callStatus=>{return nativeModule().ubrn_uniffi_breez_sdk_spark_fn_func_new_rest_chain_service(FfiConverterString.lower(url),FfiConverterTypeNetwork.lower(network),FfiConverterTypeChainApiType.lower(apiType),FfiConverterOptionalTypeCredentials.lower(credentials),callStatus);},/*liftString:*/FfiConverterString.lift));}/**
 ...
 * connection pool.
 */export function newSspConnectionManager(userAgent){return FfiConverterTypeSspConnectionManager.lift(uniffiCaller.rustCall(/*caller:*/callStatus=>{return nativeModule().ubrn_uniffi_breez_sdk_spark_fn_func_new_ssp_connection_manager(FfiConverterOptionalString.lower(userAgent),callStatus);},/*liftString:*/FfiConverterString.lift));}/**
 ...
 */export const PrepareLnurlPayRequest=(()=>{const defaults=()=>({comment:undefined,validateSuccessActionUrl:undefined,tokenIdentifier:undefined,conversionOptions:undefined,feePolicy:undefined});const create=(()=>{return uniffiCreateRecord(defaults);})();return Object.freeze({/**
     ...
     */new:create,/**
     * Defaults specified in the {@link breez_sdk_spark} crate.
     */defaults:()=>Object.freeze(defaults())});})();const FfiConverterTypePrepareLnurlPayRequest=(()=>{class FFIConverter extends AbstractFfiConverterByteArray{read(from){return{amount:FfiConverterTypeu128.read(from),payRequest:FfiConverterTypeLnurlPayRequestDetails.read(from),comment:FfiConverterOptionalString.read(from),validateSuccessActionUrl:FfiConverterOptionalBool.read(from),tokenIdentifier:FfiConverterOptionalString.read(from),conversionOptions:FfiConverterOptionalTypeConversionOptions.read(from),feePolicy:FfiConverterOptionalTypeFeePolicy.read(from)};}write(value,into){FfiConverterTypeu128.write(value.amount,into);FfiConverterTypeLnurlPayRequestDetails.write(value.payRequest,into);FfiConverterOptionalString.write(value.comment,into);FfiConverterOptionalBool.write(value.validateSuccessActionUrl,into);FfiConverterOptionalString.write(value.tokenIdentifier,into);FfiConverterOptionalTypeConversionOptions.write(value.conversionOptions,into);FfiConverterOptionalTypeFeePolicy.write(value.feePolicy,into);}allocationSize(value){return FfiConverterTypeu128.allocationSize(value.amount)+FfiConverterTypeLnurlPayRequestDetails.allocationSize(value.payRequest)+FfiConverterOptionalString.allocationSize(value.comment)+FfiConverterOptionalBool.allocationSize(value.validateSuccessActionUrl)+FfiConverterOptionalString.allocationSize(value.tokenIdentifier)+FfiConverterOptionalTypeConversionOptions.allocationSize(value.conversionOptions)+FfiConverterOptionalTypeFeePolicy.allocationSize(value.feePolicy);}}return new FFIConverter();})();/**
 ...
 */export const Session=(()=>{const defaults=()=>({});const create=(()=>{return uniffiCreateRecord(defaults);})();return Object.freeze({/**
     ...
     */new:create,/**
     * Defaults specified in the {@link breez_sdk_spark} crate.
     */defaults:()=>Object.freeze(defaults())});})();const FfiConverterTypeSession=(()=>{class FFIConverter extends AbstractFfiConverterByteArray{read(from){return{token:FfiConverterString.read(from),expiration:FfiConverterUInt64.read(from)};}write(value,into){FfiConverterString.write(value.token,into);FfiConverterUInt64.write(value.expiration,into);}allocationSize(value){return FfiConverterString.allocationSize(value.token)+FfiConverterUInt64.allocationSize(value.expiration);}}return new FFIConverter();})();/**
 ...
 */export let ServiceStatus=/*#__PURE__*/function(ServiceStatus){/**
   ...
   */ServiceStatus[ServiceStatus["Major"]=4]="Major";return ServiceStatus;}({});const FfiConverterTypeServiceStatus=(()=>{const ordinalConverter=FfiConverterInt32;class FFIConverter extends AbstractFfiConverterByteArray{read(from){switch(ordinalConverter.read(from)){case 1:return ServiceStatus.Operational;case 2:return ServiceStatus.Degraded;case 3:return ServiceStatus.Partial;case 4:return ServiceStatus.Unknown;case 5:return ServiceStatus.Major;default:throw new UniffiInternalError.UnexpectedEnumCase();}}write(value,into){switch(value){case ServiceStatus.Operational:return ordinalConverter.write(1,into);case ServiceStatus.Degraded:return ordinalConverter.write(2,into);case ServiceStatus.Partial:return ordinalConverter.write(3,into);case ServiceStatus.Unknown:return ordinalConverter.write(4,into);case ServiceStatus.Major:return ordinalConverter.write(5,into);}}allocationSize(value){return ordinalConverter.allocationSize(0);}}return new FFIConverter();})();// Error type: SessionManagerError
// Enum: SessionManagerError
export let SessionManagerError_Tags=/*#__PURE__*/function(SessionManagerError_Tags){SessionManagerError_Tags["NotFound"]="NotFound";SessionManagerError_Tags["Generic"]="Generic";return SessionManagerError_Tags;}({});export const SessionManagerError=(()=>{class NotFound_ extends UniffiError{/**
     * @private
     * This field is private and should not be used, use `tag` instead.
     */[uniffiTypeNameSymbol]='SessionManagerError';tag=SessionManagerError_Tags.NotFound;constructor(){super('SessionManagerError','NotFound');}static new(){return new NotFound_();}static instanceOf(obj){return obj.tag===SessionManagerError_Tags.NotFound;}static hasInner(obj){return false;}}class Generic_ extends UniffiError{/**
     * @private
     * This field is private and should not be used, use `tag` instead.
     */[uniffiTypeNameSymbol]='SessionManagerError';tag=SessionManagerError_Tags.Generic;constructor(v0){super('SessionManagerError','Generic');this.inner=Object.freeze([v0]);}static new(v0){return new Generic_(v0);}static instanceOf(obj){return obj.tag===SessionManagerError_Tags.Generic;}static hasInner(obj){return Generic_.instanceOf(obj);}static getInner(obj){return obj.inner;}}function instanceOf(obj){return obj[uniffiTypeNameSymbol]==='SessionManagerError';}return Object.freeze({instanceOf,NotFound:NotFound_,Generic:Generic_});})();// FfiConverter for enum SessionManagerError
const FfiConverterTypeSessionManagerError=(()=>{const ordinalConverter=FfiConverterInt32;class FFIConverter extends AbstractFfiConverterByteArray{read(from){switch(ordinalConverter.read(from)){case 1:return new SessionManagerError.NotFound();case 2:return new SessionManagerError.Generic(FfiConverterString.read(from));default:throw new UniffiInternalError.UnexpectedEnumCase();}}write(value,into){switch(value.tag){case SessionManagerError_Tags.NotFound:{ordinalConverter.write(1,into);return;}case SessionManagerError_Tags.Generic:{ordinalConverter.write(2,into);const inner=value.inner;FfiConverterString.write(inner[0],into);return;}default:// Throwing from here means that SessionManagerError_Tags hasn't matched an ordinal.
throw new UniffiInternalError.UnexpectedEnumCase();}}allocationSize(value){switch(value.tag){case SessionManagerError_Tags.NotFound:{return ordinalConverter.allocationSize(1);}case SessionManagerError_Tags.Generic:{const inner=value.inner;let size=ordinalConverter.allocationSize(2);size+=FfiConverterString.allocationSize(inner[0]);return size;}default:throw new UniffiInternalError.UnexpectedEnumCase();}}}return new FFIConverter();})();// Error type: SignerError
// Enum: SignerError
 ...
 */export const StoragePaymentDetailsFilter=(()=>{class Spark_ extends UniffiEnum{/**
     * @private
     * This field is private and should not be used, use `tag` instead.
     */[uniffiTypeNameSymbol]='StoragePaymentDetailsFilter';tag=StoragePaymentDetailsFilter_Tags.Spark;constructor(inner){super('StoragePaymentDetailsFilter','Spark');this.inner=Object.freeze(inner);}static new(inner){return new Spark_(inner);}static instanceOf(obj){return obj.tag===StoragePaymentDetailsFilter_Tags.Spark;}}class Token_ extends UniffiEnum{/**
     * @private
     * This field is private and should not be used, use `tag` instead.
     */[uniffiTypeNameSymbol]='StoragePaymentDetailsFilter';tag=StoragePaymentDetailsFilter_Tags.Token;constructor(inner){super('StoragePaymentDetailsFilter','Token');this.inner=Object.freeze(inner);}static new(inner){return new Token_(inner);}static instanceOf(obj){return obj.tag===StoragePaymentDetailsFilter_Tags.Token;}}class Lightning_ extends UniffiEnum{/**
     * @private
     * This field is private and should not be used, use `tag` instead.
 ...
 * same network and operator pool. The TLS settings and user agent of the
 * first SDK to connect to a given operator are reused for everyone afterwards.
 */export class ConnectionManager extends UniffiAbstractObject{[uniffiTypeNameSymbol]='ConnectionManager';// No primary constructor declared for this class.
constructor(pointer){super();this[pointerLiteralSymbol]=pointer;this[destructorGuardSymbol]=uniffiTypeConnectionManagerObjectFactory.bless(pointer);}/**
   * {@inheritDoc uniffi-bindgen-react-native#UniffiAbstractObject.uniffiDestroy}
   */uniffiDestroy(){const ptr=this[destructorGuardSymbol];if(ptr!==undefined){const pointer=uniffiTypeConnectionManagerObjectFactory.pointer(this);uniffiTypeConnectionManagerObjectFactory.freePointer(pointer);uniffiTypeConnectionManagerObjectFactory.unbless(ptr);delete this[destructorGuardSymbol];}}static instanceOf(obj){return uniffiTypeConnectionManagerObjectFactory.isConcreteType(obj);}}const uniffiTypeConnectionManagerObjectFactory=(()=>{return{create(pointer){const instance=Object.create(ConnectionManager.prototype);instance[pointerLiteralSymbol]=pointer;instance[destructorGuardSymbol]=this.bless(pointer);instance[uniffiTypeNameSymbol]='ConnectionManager';return instance;},bless(p){return uniffiCaller.rustCall(/*caller:*/status=>nativeModule().ubrn_uniffi_internal_fn_method_connectionmanager_ffi__bless_pointer(p,status),/*liftString:*/FfiConverterString.lift);},unbless(ptr){ptr.markDestroyed();},pointer(obj){if(obj[destructorGuardSymbol]===undefined){throw new UniffiInternalError.UnexpectedNullPointer();}return obj[pointerLiteralSymbol];},clonePointer(obj){const pointer=this.pointer(obj);return uniffiCaller.rustCall(/*caller:*/callStatus=>nativeModule().ubrn_uniffi_breez_sdk_spark_fn_clone_connectionmanager(pointer,callStatus),/*liftString:*/FfiConverterString.lift);},freePointer(pointer){uniffiCaller.rustCall(/*caller:*/callStatus=>nativeModule().ubrn_uniffi_breez_sdk_spark_fn_free_connectionmanager(pointer,callStatus),/*liftString:*/FfiConverterString.lift);},isConcreteType(obj){return obj[destructorGuardSymbol]&&obj[uniffiTypeNameSymbol]==='ConnectionManager';}};})();// FfiConverter for ConnectionManagerInterface
const FfiConverterTypeConnectionManager=new FfiConverterObject(uniffiTypeConnectionManagerObjectFactory);/**
 ...
 */export class Passkey extends UniffiAbstractObject{[uniffiTypeNameSymbol]='Passkey';/**
   ...
   */async listLabels(asyncOpts_)/*throws*/{const __stack=uniffiIsDebug?new Error().stack:undefined;try{return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller,/*rustFutureFunc:*/()=>{return nativeModule().ubrn_uniffi_breez_sdk_spark_fn_method_passkey_list_labels(uniffiTypePasskeyObjectFactory.clonePointer(this));},/*pollFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_poll_rust_buffer,/*cancelFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_cancel_rust_buffer,/*completeFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_complete_rust_buffer,/*freeFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_free_rust_buffer,/*liftFunc:*/FfiConverterArrayString.lift.bind(FfiConverterArrayString),/*liftString:*/FfiConverterString.lift,/*asyncOpts:*/asyncOpts_,/*errorHandler:*/FfiConverterTypePasskeyError.lift.bind(FfiConverterTypePasskeyError));}catch(__error){if(uniffiIsDebug&&__error instanceof Error){__error.stack=__stack;}throw __error;}}/**
 ...
 */export class SdkBuilder extends UniffiAbstractObject{[uniffiTypeNameSymbol]='SdkBuilder';/**
   ...
   */async withConnectionManager(connectionManager,asyncOpts_){const __stack=uniffiIsDebug?new Error().stack:undefined;try{return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller,/*rustFutureFunc:*/()=>{return nativeModule().ubrn_uniffi_breez_sdk_spark_fn_method_sdkbuilder_with_connection_manager(uniffiTypeSdkBuilderObjectFactory.clonePointer(this),FfiConverterTypeConnectionManager.lower(connectionManager));},/*pollFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_poll_void,/*cancelFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_cancel_void,/*completeFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_complete_void,/*freeFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_free_void,/*liftFunc:*/_v=>{},/*liftString:*/FfiConverterString.lift,/*asyncOpts:*/asyncOpts_);}catch(__error){if(uniffiIsDebug&&__error instanceof Error){__error.stack=__stack;}throw __error;}}/**
   ...
   */async withSessionManager(sessionManager,asyncOpts_){const __stack=uniffiIsDebug?new Error().stack:undefined;try{return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller,/*rustFutureFunc:*/()=>{return nativeModule().ubrn_uniffi_breez_sdk_spark_fn_method_sdkbuilder_with_session_manager(uniffiTypeSdkBuilderObjectFactory.clonePointer(this),FfiConverterTypeSessionManager.lower(sessionManager));},/*pollFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_poll_void,/*cancelFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_cancel_void,/*completeFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_complete_void,/*freeFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_free_void,/*liftFunc:*/_v=>{},/*liftString:*/FfiConverterString.lift,/*asyncOpts:*/asyncOpts_);}catch(__error){if(uniffiIsDebug&&__error instanceof Error){__error.stack=__stack;}throw __error;}}/**
   * Sets a shared SSP connection manager to be reused across SDK instances.
   * Arguments:
   * - `manager`: The shared SSP connection manager.
   */async withSspConnectionManager(manager,asyncOpts_){const __stack=uniffiIsDebug?new Error().stack:undefined;try{return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller,/*rustFutureFunc:*/()=>{return nativeModule().ubrn_uniffi_breez_sdk_spark_fn_method_sdkbuilder_with_ssp_connection_manager(uniffiTypeSdkBuilderObjectFactory.clonePointer(this),FfiConverterTypeSspConnectionManager.lower(manager));},/*pollFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_poll_void,/*cancelFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_cancel_void,/*completeFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_complete_void,/*freeFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_free_void,/*liftFunc:*/_v=>{},/*liftString:*/FfiConverterString.lift,/*asyncOpts:*/asyncOpts_);}catch(__error){if(uniffiIsDebug&&__error instanceof Error){__error.stack=__stack;}throw __error;}}/**
 ...
 * backed by an in-memory map (default) or a shared database for cross-pod
 * auth sharing.
 */export class SessionManagerImpl extends UniffiAbstractObject{[uniffiTypeNameSymbol]='SessionManagerImpl';// No primary constructor declared for this class.
constructor(pointer){super();this[pointerLiteralSymbol]=pointer;this[destructorGuardSymbol]=uniffiTypeSessionManagerImplObjectFactory.bless(pointer);}async getSession(serviceIdentityKey,asyncOpts_)/*throws*/{const __stack=uniffiIsDebug?new Error().stack:undefined;try{return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller,/*rustFutureFunc:*/()=>{return nativeModule().ubrn_uniffi_breez_sdk_spark_fn_method_sessionmanager_get_session(uniffiTypeSessionManagerImplObjectFactory.clonePointer(this),FfiConverterTypePublicKey.lower(serviceIdentityKey));},/*pollFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_poll_rust_buffer,/*cancelFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_cancel_rust_buffer,/*completeFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_complete_rust_buffer,/*freeFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_free_rust_buffer,/*liftFunc:*/FfiConverterTypeSession.lift.bind(FfiConverterTypeSession),/*liftString:*/FfiConverterString.lift,/*asyncOpts:*/asyncOpts_,/*errorHandler:*/FfiConverterTypeSessionManagerError.lift.bind(FfiConverterTypeSessionManagerError));}catch(__error){if(uniffiIsDebug&&__error instanceof Error){__error.stack=__stack;}throw __error;}}async setSession(serviceIdentityKey,session,asyncOpts_)/*throws*/{const __stack=uniffiIsDebug?new Error().stack:undefined;try{return await uniffiRustCallAsync(/*rustCaller:*/uniffiCaller,/*rustFutureFunc:*/()=>{return nativeModule().ubrn_uniffi_breez_sdk_spark_fn_method_sessionmanager_set_session(uniffiTypeSessionManagerImplObjectFactory.clonePointer(this),FfiConverterTypePublicKey.lower(serviceIdentityKey),FfiConverterTypeSession.lower(session));},/*pollFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_poll_void,/*cancelFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_cancel_void,/*completeFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_complete_void,/*freeFunc:*/nativeModule().ubrn_ffi_breez_sdk_spark_rust_future_free_void,/*liftFunc:*/_v=>{},/*liftString:*/FfiConverterString.lift,/*asyncOpts:*/asyncOpts_,/*errorHandler:*/FfiConverterTypeSessionManagerError.lift.bind(FfiConverterTypeSessionManagerError));}catch(__error){if(uniffiIsDebug&&__error instanceof Error){__error.stack=__stack;}throw __error;}}/**
   * {@inheritDoc uniffi-bindgen-react-native#UniffiAbstractObject.uniffiDestroy}
   */uniffiDestroy(){const ptr=this[destructorGuardSymbol];if(ptr!==undefined){const pointer=uniffiTypeSessionManagerImplObjectFactory.pointer(this);uniffiTypeSessionManagerImplObjectFactory.freePointer(pointer);uniffiTypeSessionManagerImplObjectFactory.unbless(ptr);delete this[destructorGuardSymbol];}}static instanceOf(obj){return uniffiTypeSessionManagerImplObjectFactory.isConcreteType(obj);}}const uniffiTypeSessionManagerImplObjectFactory=(()=>{return{create(pointer){const instance=Object.create(SessionManagerImpl.prototype);instance[pointerLiteralSymbol]=pointer;instance[destructorGuardSymbol]=this.bless(pointer);instance[uniffiTypeNameSymbol]='SessionManagerImpl';return instance;},bless(p){return uniffiCaller.rustCall(/*caller:*/status=>nativeModule().ubrn_uniffi_internal_fn_method_sessionmanager_ffi__bless_pointer(p,status),/*liftString:*/FfiConverterString.lift);},unbless(ptr){ptr.markDestroyed();},pointer(obj){if(obj[destructorGuardSymbol]===undefined){throw new UniffiInternalError.UnexpectedNullPointer();}return obj[pointerLiteralSymbol];},clonePointer(obj){const pointer=this.pointer(obj);return uniffiCaller.rustCall(/*caller:*/callStatus=>nativeModule().ubrn_uniffi_breez_sdk_spark_fn_clone_sessionmanager(pointer,callStatus),/*liftString:*/FfiConverterString.lift);},freePointer(pointer){uniffiCaller.rustCall(/*caller:*/callStatus=>nativeModule().ubrn_uniffi_breez_sdk_spark_fn_free_sessionmanager(pointer,callStatus),/*liftString:*/FfiConverterString.lift);},isConcreteType(obj){return obj[destructorGuardSymbol]&&obj[uniffiTypeNameSymbol]==='SessionManagerImpl';}};})();// FfiConverter for SessionManager
const FfiConverterTypeSessionManager=new FfiConverterObjectWithCallbacks(uniffiTypeSessionManagerImplObjectFactory);// Add a vtavble for the callbacks that go in SessionManager.
// Put the implementation in a struct so we don't pollute the top-level namespace
const uniffiCallbackInterfaceSessionManager={// Create the VTable using a series of closures.
// ts automatically converts these into C callback functions.
vtable:{getSession:(uniffiHandle,serviceIdentityKey,uniffiFutureCallback,uniffiCallbackData)=>{const uniffiMakeCall=async signal=>{const jsCallback=FfiConverterTypeSessionManager.lift(uniffiHandle);return await jsCallback.getSession(FfiConverterTypePublicKey.lift(serviceIdentityKey),{signal});};const uniffiHandleSuccess=returnValue=>{uniffiFutureCallback.call(uniffiFutureCallback,uniffiCallbackData,/* UniffiForeignFutureStructRustBuffer */{returnValue:FfiConverterTypeSession.lower(returnValue),callStatus:uniffiCaller.createCallStatus()});};const uniffiHandleError=(code,errorBuf)=>{uniffiFutureCallback.call(uniffiFutureCallback,uniffiCallbackData,/* UniffiForeignFutureStructRustBuffer */{returnValue:/*empty*/new Uint8Array(0),// TODO create callstatus with error.
callStatus:uniffiCaller.createErrorStatus(code,errorBuf)});};const uniffiForeignFuture=uniffiTraitInterfaceCallAsyncWithError(/*makeCall:*/uniffiMakeCall,/*handleSuccess:*/uniffiHandleSuccess,/*handleError:*/uniffiHandleError,/*isErrorType:*/SessionManagerError.instanceOf,/*lowerError:*/FfiConverterTypeSessionManagerError.lower.bind(FfiConverterTypeSessionManagerError),/*lowerString:*/FfiConverterString.lower);return uniffiForeignFuture;},setSession:(uniffiHandle,serviceIdentityKey,session,uniffiFutureCallback,uniffiCallbackData)=>{const uniffiMakeCall=async signal=>{const jsCallback=FfiConverterTypeSessionManager.lift(uniffiHandle);return await jsCallback.setSession(FfiConverterTypePublicKey.lift(serviceIdentityKey),FfiConverterTypeSession.lift(session),{signal});};const uniffiHandleSuccess=returnValue=>{uniffiFutureCallback.call(uniffiFutureCallback,uniffiCallbackData,/* UniffiForeignFutureStructVoid */{callStatus:uniffiCaller.createCallStatus()});};const uniffiHandleError=(code,errorBuf)=>{uniffiFutureCallback.call(uniffiFutureCallback,uniffiCallbackData,/* UniffiForeignFutureStructVoid */{// TODO create callstatus with error.
callStatus:uniffiCaller.createErrorStatus(code,errorBuf)});};const uniffiForeignFuture=uniffiTraitInterfaceCallAsyncWithError(/*makeCall:*/uniffiMakeCall,/*handleSuccess:*/uniffiHandleSuccess,/*handleError:*/uniffiHandleError,/*isErrorType:*/SessionManagerError.instanceOf,/*lowerError:*/FfiConverterTypeSessionManagerError.lower.bind(FfiConverterTypeSessionManagerError),/*lowerString:*/FfiConverterString.lower);return uniffiForeignFuture;},uniffiFree:uniffiHandle=>{// SessionManager: this will throw a stale handle error if the handle isn't found.
FfiConverterTypeSessionManager.drop(uniffiHandle);}},register:()=>{nativeModule().ubrn_uniffi_breez_sdk_spark_fn_init_callback_vtable_sessionmanager(uniffiCallbackInterfaceSessionManager.vtable);}};/**
 ...
 * - Connections close when the last `Arc<SspConnectionManager>` is dropped.
 * `BreezSdk::disconnect` does not close them.
 */export class SspConnectionManager extends UniffiAbstractObject{[uniffiTypeNameSymbol]='SspConnectionManager';// No primary constructor declared for this class.
constructor(pointer){super();this[pointerLiteralSymbol]=pointer;this[destructorGuardSymbol]=uniffiTypeSspConnectionManagerObjectFactory.bless(pointer);}/**
   * {@inheritDoc uniffi-bindgen-react-native#UniffiAbstractObject.uniffiDestroy}
   */uniffiDestroy(){const ptr=this[destructorGuardSymbol];if(ptr!==undefined){const pointer=uniffiTypeSspConnectionManagerObjectFactory.pointer(this);uniffiTypeSspConnectionManagerObjectFactory.freePointer(pointer);uniffiTypeSspConnectionManagerObjectFactory.unbless(ptr);delete this[destructorGuardSymbol];}}static instanceOf(obj){return uniffiTypeSspConnectionManagerObjectFactory.isConcreteType(obj);}}const uniffiTypeSspConnectionManagerObjectFactory=(()=>{return{create(pointer){const instance=Object.create(SspConnectionManager.prototype);instance[pointerLiteralSymbol]=pointer;instance[destructorGuardSymbol]=this.bless(pointer);instance[uniffiTypeNameSymbol]='SspConnectionManager';return instance;},bless(p){return uniffiCaller.rustCall(/*caller:*/status=>nativeModule().ubrn_uniffi_internal_fn_method_sspconnectionmanager_ffi__bless_pointer(p,status),/*liftString:*/FfiConverterString.lift);},unbless(ptr){ptr.markDestroyed();},pointer(obj){if(obj[destructorGuardSymbol]===undefined){throw new UniffiInternalError.UnexpectedNullPointer();}return obj[pointerLiteralSymbol];},clonePointer(obj){const pointer=this.pointer(obj);return uniffiCaller.rustCall(/*caller:*/callStatus=>nativeModule().ubrn_uniffi_breez_sdk_spark_fn_clone_sspconnectionmanager(pointer,callStatus),/*liftString:*/FfiConverterString.lift);},freePointer(pointer){uniffiCaller.rustCall(/*caller:*/callStatus=>nativeModule().ubrn_uniffi_breez_sdk_spark_fn_free_sspconnectionmanager(pointer,callStatus),/*liftString:*/FfiConverterString.lift);},isConcreteType(obj){return obj[destructorGuardSymbol]&&obj[uniffiTypeNameSymbol]==='SspConnectionManager';}};})();// FfiConverter for SspConnectionManagerInterface
const FfiConverterTypeSspConnectionManager=new FfiConverterObject(uniffiTypeSspConnectionManagerObjectFactory);/**
...
const FfiConverterOptionalArrayTypeSparkHtlcStatus=new FfiConverterOptional(FfiConverterArrayTypeSparkHtlcStatus);// FfiConverter for Array<StoragePaymentDetailsFilter> | undefined
const FfiConverterOptionalArrayTypeStoragePaymentDetailsFilter=new FfiConverterOptional(FfiConverterArrayTypeStoragePaymentDetailsFilter);/**
