...
exports.default = exports.UrlSuccessActionData = exports.UnversionedRecordChange = exports.SyncStorageImpl = exports.SyncStorageError_Tags = exports.SyncStorageError = exports.Symbol = exports.SuccessAction_Tags = exports.SuccessActionProcessed_Tags = exports.SuccessActionProcessed = exports.SuccessAction = exports.SparkInvoiceDetails = exports.SparkAddressDetails = exports.SilentPaymentAddressDetails = exports.ServiceConnectivityError_Tags = exports.ServiceConnectivityError = exports.RestResponse = exports.RestClientImpl = exports.RecordId = exports.RecordChange = exports.Record = exports.Rate = exports.PaymentRequestSource = exports.OutgoingChange = exports.MessageSuccessActionData = exports.LocalizedName = exports.LocaleOverrides = exports.LnurlWithdrawRequestDetails = exports.LnurlPayRequestDetails = exports.LnurlErrorDetails = exports.LnurlCallbackStatus_Tags = exports.LnurlCallbackStatus = exports.LnurlAuthRequestDetails = exports.LightningAddressDetails = exports.InputType_Tags = exports.InputType = exports.IncomingChange = exports.FiatServiceImpl = exports.FiatCurrency = exports.ExternalInputParser = exports.CurrencyInfo = exports.Bolt12OfferDetails = exports.Bolt12OfferBlindedPath = exports.Bolt12Offer = exports.Bolt12InvoiceRequestDetails = exports.Bolt12InvoiceDetails = exports.Bolt12Invoice = exports.Bolt11RouteHintHop = exports.Bolt11RouteHint = exports.Bolt11InvoiceDetails = exports.Bolt11Invoice = exports.BitcoinNetwork = exports.BitcoinAddressDetails = exports.Bip21Extra = exports.Bip21Details = exports.Amount_Tags = exports.Amount = exports.AesSuccessActionDataResult_Tags = exports.AesSuccessActionDataResult = exports.AesSuccessActionDataDecrypted = exports.AesSuccessActionData = void 0;
 ...
 */
const IncomingChange = exports.IncomingChange = (() => {
  const defaults = () => ({});
  const create = (() => {
    return (0, _uniffiBindgenReactNative.uniffiCreateRecord)(defaults);
  })();
...
const FfiConverterTypeIncomingChange = (() => {
  class FFIConverter extends _uniffiBindgenReactNative.AbstractFfiConverterByteArray {
    ...
    allocationSize(value) {
      return FfiConverterTypeRecord.allocationSize(value.newState) + FfiConverterOptionalTypeRecord.allocationSize(value.oldState);
    }
  }
  return new FFIConverter();
})();
 ...
 */
const OutgoingChange = exports.OutgoingChange = (() => {
  const defaults = () => ({});
  const create = (() => {
    return (0, _uniffiBindgenReactNative.uniffiCreateRecord)(defaults);
  })();
...
const FfiConverterTypeOutgoingChange = (() => {
  class FFIConverter extends _uniffiBindgenReactNative.AbstractFfiConverterByteArray {
    ...
    allocationSize(value) {
      return FfiConverterTypeRecordChange.allocationSize(value.change) + FfiConverterOptionalTypeRecord.allocationSize(value.parent);
    }
  }
  return new FFIConverter();
})();
  ...
  class FFIConverter extends _uniffiBindgenReactNative.AbstractFfiConverterByteArray {
    read(from) {
      return {
        ...
        revision: _uniffiBindgenReactNative.FfiConverterUInt64.read(from),
    ...
    write(value, into) {
      ...
      _uniffiBindgenReactNative.FfiConverterUInt64.write(value.revision, into);
      FfiConverterString.write(value.schemaVersion, into);
      FfiConverterMapStringString.write(value.data, into);
    }
    allocationSize(value) {
      return FfiConverterTypeRecordId.allocationSize(value.id) + _uniffiBindgenReactNative.FfiConverterUInt64.allocationSize(value.revision) + FfiConverterString.allocationSize(value.schemaVersion) + FfiConverterMapStringString.allocationSize(value.data);
    }
  }
  return new FFIConverter();
})();
 ...
 */
const RecordChange = exports.RecordChange = (() => {
  const defaults = () => ({});
  const create = (() => {
    return (0, _uniffiBindgenReactNative.uniffiCreateRecord)(defaults);
  })();
...
const FfiConverterTypeRecordChange = (() => {
  class FFIConverter extends _uniffiBindgenReactNative.AbstractFfiConverterByteArray {
    ...
    allocationSize(value) {
      return FfiConverterTypeRecordId.allocationSize(value.id) + FfiConverterString.allocationSize(value.schemaVersion) + FfiConverterMapStringString.allocationSize(value.updatedFields) + _uniffiBindgenReactNative.FfiConverterUInt64.allocationSize(value.revision);
    }
  }
  return new FFIConverter();
})();
 ...
 */
const RecordId = exports.RecordId = (() => {
  const defaults = () => ({});
  const create = (() => {
    return (0, _uniffiBindgenReactNative.uniffiCreateRecord)(defaults);
  })();
...
const FfiConverterTypeRecordId = (() => {
  class FFIConverter extends _uniffiBindgenReactNative.AbstractFfiConverterByteArray {
    ...
    allocationSize(value) {
      return FfiConverterString.allocationSize(value.type) + FfiConverterString.allocationSize(value.dataId);
    }
  }
  return new FFIConverter();
})();
 ...
 */
const UnversionedRecordChange = exports.UnversionedRecordChange = (() => {
  const defaults = () => ({});
  const create = (() => {
    return (0, _uniffiBindgenReactNative.uniffiCreateRecord)(defaults);
  })();
...
const FfiConverterTypeUnversionedRecordChange = (() => {
  class FFIConverter extends _uniffiBindgenReactNative.AbstractFfiConverterByteArray {
    ...
    allocationSize(value) {
      return FfiConverterTypeRecordId.allocationSize(value.id) + FfiConverterString.allocationSize(value.schemaVersion) + FfiConverterMapStringString.allocationSize(value.updatedFields);
    }
  }
  return new FFIConverter();
})();
...
let SyncStorageError_Tags = exports.SyncStorageError_Tags = /*#__PURE__*/function (SyncStorageError_Tags) {
  SyncStorageError_Tags["Implementation"] = "Implementation";
  SyncStorageError_Tags["InitializationError"] = "InitializationError";
  SyncStorageError_Tags["Serialization"] = "Serialization";
  return SyncStorageError_Tags;
}({});
/**
 * Errors that can occur during storage operations
 */
const SyncStorageError = exports.SyncStorageError = (() => {
  class Implementation_ extends _uniffiBindgenReactNative.UniffiError {
    /**
     * @private
     * This field is private and should not be used, use `tag` instead.
     */
    [_uniffiBindgenReactNative.uniffiTypeNameSymbol] = 'SyncStorageError';
  ...
  function instanceOf(obj) {
    return obj[_uniffiBindgenReactNative.uniffiTypeNameSymbol] === 'SyncStorageError';
  }
  return Object.freeze({
    instanceOf,
...
const FfiConverterTypeSyncStorageError = (() => {
  ...
  class FFIConverter extends _uniffiBindgenReactNative.AbstractFfiConverterByteArray {
    read(from) {
      switch (ordinalConverter.read(from)) {
        case 1:
          return new SyncStorageError.Implementation(FfiConverterString.read(from));
        case 2:
          return new SyncStorageError.InitializationError(FfiConverterString.read(from));
        case 3:
          return new SyncStorageError.Serialization(FfiConverterString.read(from));
        default:
          throw new _uniffiBindgenReactNative.UniffiInternalError.UnexpectedEnumCase();
      }
    }
 ...
 * Trait covering fiat-related functionality
 */
class FiatServiceImpl extends _uniffiBindgenReactNative.UniffiAbstractObject {
  [_uniffiBindgenReactNative.uniffiTypeNameSymbol] = 'FiatServiceImpl';
  // No primary constructor declared for this class.
  constructor(pointer) {
    super();
    this[_uniffiBindgenReactNative.pointerLiteralSymbol] = pointer;
    this[_uniffiBindgenReactNative.destructorGuardSymbol] = uniffiTypeFiatServiceImplObjectFactory.bless(pointer);
  }
  ...
  async fetchFiatCurrencies(asyncOpts_) /*throws*/{
    ...
    try {
      return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_fn_method_fiatservice_fetch_fiat_currencies(uniffiTypeFiatServiceImplObjectFactory.clonePointer(this));
  ...
  async fetchFiatRates(asyncOpts_) /*throws*/{
    ...
    try {
      return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_fn_method_fiatservice_fetch_fiat_rates(uniffiTypeFiatServiceImplObjectFactory.clonePointer(this));
...
exports.FiatServiceImpl = FiatServiceImpl;
const uniffiTypeFiatServiceImplObjectFactory = {
  create(pointer) {
    ...
    instance[_uniffiBindgenReactNative.uniffiTypeNameSymbol] = 'FiatServiceImpl';
    return instance;
  },
  bless(p) {
    return uniffiCaller.rustCall(/*caller:*/status => (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_internal_fn_method_fiatservice_ffi__bless_pointer(p, status), /*liftString:*/FfiConverterString.lift);
  },
  unbless(ptr) {
    ptr.markDestroyed();
  },
  ...
  clonePointer(obj) {
    ...
    return uniffiCaller.rustCall(/*caller:*/callStatus => (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_fn_clone_fiatservice(pointer, callStatus), /*liftString:*/FfiConverterString.lift);
  },
  freePointer(pointer) {
    uniffiCaller.rustCall(/*caller:*/callStatus => (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_fn_free_fiatservice(pointer, callStatus), /*liftString:*/FfiConverterString.lift);
  },
  isConcreteType(obj) {
    return obj[_uniffiBindgenReactNative.destructorGuardSymbol] && obj[_uniffiBindgenReactNative.uniffiTypeNameSymbol] === 'FiatServiceImpl';
  }
};
// FfiConverter for FiatService
const FfiConverterTypeFiatService = new _uniffiBindgenReactNative.FfiConverterObjectWithCallbacks(uniffiTypeFiatServiceImplObjectFactory);
...
const uniffiCallbackInterfaceFiatService = {
  ...
  register: () => {
    (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_fn_init_callback_vtable_fiatservice(uniffiCallbackInterfaceFiatService.vtable);
  }
};
...
class SyncStorageImpl extends _uniffiBindgenReactNative.UniffiAbstractObject {
  [_uniffiBindgenReactNative.uniffiTypeNameSymbol] = 'SyncStorageImpl';
  // No primary constructor declared for this class.
  constructor(pointer) {
    super();
    this[_uniffiBindgenReactNative.pointerLiteralSymbol] = pointer;
    this[_uniffiBindgenReactNative.destructorGuardSymbol] = uniffiTypeSyncStorageImplObjectFactory.bless(pointer);
  }
  async addOutgoingChange(record, asyncOpts_) /*throws*/{
    const __stack = uniffiIsDebug ? new Error().stack : undefined;
    try {
      return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_add_outgoing_change(uniffiTypeSyncStorageImplObjectFactory.clonePointer(this), FfiConverterTypeUnversionedRecordChange.lower(record));
      }, /*pollFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_poll_u64, /*cancelFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_cancel_u64, /*completeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_complete_u64, /*freeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_free_u64, /*liftFunc:*/_uniffiBindgenReactNative.FfiConverterUInt64.lift.bind(_uniffiBindgenReactNative.FfiConverterUInt64), /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeSyncStorageError.lift.bind(FfiConverterTypeSyncStorageError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
      }
  ...
  async completeOutgoingSync(record, asyncOpts_) /*throws*/{
    const __stack = uniffiIsDebug ? new Error().stack : undefined;
    try {
      return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_complete_outgoing_sync(uniffiTypeSyncStorageImplObjectFactory.clonePointer(this), FfiConverterTypeRecord.lower(record));
      }, /*pollFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_poll_void, /*cancelFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_cancel_void, /*completeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_complete_void, /*freeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeSyncStorageError.lift.bind(FfiConverterTypeSyncStorageError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
      }
  ...
  async getPendingOutgoingChanges(limit, asyncOpts_) /*throws*/{
    const __stack = uniffiIsDebug ? new Error().stack : undefined;
    try {
      return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_get_pending_outgoing_changes(uniffiTypeSyncStorageImplObjectFactory.clonePointer(this), _uniffiBindgenReactNative.FfiConverterUInt32.lower(limit));
      }, /*pollFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_poll_rust_buffer, /*cancelFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_cancel_rust_buffer, /*completeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_complete_rust_buffer, /*freeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_free_rust_buffer, /*liftFunc:*/FfiConverterArrayTypeOutgoingChange.lift.bind(FfiConverterArrayTypeOutgoingChange), /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeSyncStorageError.lift.bind(FfiConverterTypeSyncStorageError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
      }
   ...
   */
  async getLastRevision(asyncOpts_) /*throws*/{
    const __stack = uniffiIsDebug ? new Error().stack : undefined;
    try {
      return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_get_last_revision(uniffiTypeSyncStorageImplObjectFactory.clonePointer(this));
      }, /*pollFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_poll_u64, /*cancelFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_cancel_u64, /*completeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_complete_u64, /*freeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_free_u64, /*liftFunc:*/_uniffiBindgenReactNative.FfiConverterUInt64.lift.bind(_uniffiBindgenReactNative.FfiConverterUInt64), /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeSyncStorageError.lift.bind(FfiConverterTypeSyncStorageError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
   ...
   */
  async insertIncomingRecords(records, asyncOpts_) /*throws*/{
    const __stack = uniffiIsDebug ? new Error().stack : undefined;
    try {
      return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_insert_incoming_records(uniffiTypeSyncStorageImplObjectFactory.clonePointer(this), FfiConverterArrayTypeRecord.lower(records));
      }, /*pollFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_poll_void, /*cancelFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_cancel_void, /*completeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_complete_void, /*freeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeSyncStorageError.lift.bind(FfiConverterTypeSyncStorageError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
   ...
   */
  async deleteIncomingRecord(record, asyncOpts_) /*throws*/{
    const __stack = uniffiIsDebug ? new Error().stack : undefined;
    try {
      return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_delete_incoming_record(uniffiTypeSyncStorageImplObjectFactory.clonePointer(this), FfiConverterTypeRecord.lower(record));
      }, /*pollFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_poll_void, /*cancelFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_cancel_void, /*completeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_complete_void, /*freeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeSyncStorageError.lift.bind(FfiConverterTypeSyncStorageError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
   ...
   */
  async rebasePendingOutgoingRecords(revision, asyncOpts_) /*throws*/{
    const __stack = uniffiIsDebug ? new Error().stack : undefined;
    try {
      return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_rebase_pending_outgoing_records(uniffiTypeSyncStorageImplObjectFactory.clonePointer(this), _uniffiBindgenReactNative.FfiConverterUInt64.lower(revision));
      }, /*pollFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_poll_void, /*cancelFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_cancel_void, /*completeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_complete_void, /*freeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeSyncStorageError.lift.bind(FfiConverterTypeSyncStorageError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
   ...
   */
  async getIncomingRecords(limit, asyncOpts_) /*throws*/{
    const __stack = uniffiIsDebug ? new Error().stack : undefined;
    try {
      return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_get_incoming_records(uniffiTypeSyncStorageImplObjectFactory.clonePointer(this), _uniffiBindgenReactNative.FfiConverterUInt32.lower(limit));
      }, /*pollFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_poll_rust_buffer, /*cancelFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_cancel_rust_buffer, /*completeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_complete_rust_buffer, /*freeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_free_rust_buffer, /*liftFunc:*/FfiConverterArrayTypeIncomingChange.lift.bind(FfiConverterArrayTypeIncomingChange), /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeSyncStorageError.lift.bind(FfiConverterTypeSyncStorageError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
      }
   ...
   */
  async getLatestOutgoingChange(asyncOpts_) /*throws*/{
    const __stack = uniffiIsDebug ? new Error().stack : undefined;
    try {
      return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_get_latest_outgoing_change(uniffiTypeSyncStorageImplObjectFactory.clonePointer(this));
      }, /*pollFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_poll_rust_buffer, /*cancelFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_cancel_rust_buffer, /*completeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_complete_rust_buffer, /*freeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_free_rust_buffer, /*liftFunc:*/FfiConverterOptionalTypeOutgoingChange.lift.bind(FfiConverterOptionalTypeOutgoingChange), /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeSyncStorageError.lift.bind(FfiConverterTypeSyncStorageError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
      }
   ...
   */
  async updateRecordFromIncoming(record, asyncOpts_) /*throws*/{
    const __stack = uniffiIsDebug ? new Error().stack : undefined;
    try {
      return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_fn_method_syncstorage_update_record_from_incoming(uniffiTypeSyncStorageImplObjectFactory.clonePointer(this), FfiConverterTypeRecord.lower(record));
      }, /*pollFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_poll_void, /*cancelFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_cancel_void, /*completeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_complete_void, /*freeFunc:*/(0, _breez_sdk_commonFfi.default)().ubrn_ffi_breez_sdk_common_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeSyncStorageError.lift.bind(FfiConverterTypeSyncStorageError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
...
exports.SyncStorageImpl = SyncStorageImpl;
const uniffiTypeSyncStorageImplObjectFactory = {
  create(pointer) {
    const instance = Object.create(SyncStorageImpl.prototype);
    instance[_uniffiBindgenReactNative.pointerLiteralSymbol] = pointer;
    instance[_uniffiBindgenReactNative.destructorGuardSymbol] = this.bless(pointer);
    instance[_uniffiBindgenReactNative.uniffiTypeNameSymbol] = 'SyncStorageImpl';
    return instance;
  },
  bless(p) {
    return uniffiCaller.rustCall(/*caller:*/status => (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_internal_fn_method_syncstorage_ffi__bless_pointer(p, status), /*liftString:*/FfiConverterString.lift);
  },
  unbless(ptr) {
    ptr.markDestroyed();
  },
  ...
  clonePointer(obj) {
    const pointer = this.pointer(obj);
    return uniffiCaller.rustCall(/*caller:*/callStatus => (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_fn_clone_syncstorage(pointer, callStatus), /*liftString:*/FfiConverterString.lift);
  },
  freePointer(pointer) {
    uniffiCaller.rustCall(/*caller:*/callStatus => (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_fn_free_syncstorage(pointer, callStatus), /*liftString:*/FfiConverterString.lift);
  },
  isConcreteType(obj) {
    return obj[_uniffiBindgenReactNative.destructorGuardSymbol] && obj[_uniffiBindgenReactNative.uniffiTypeNameSymbol] === 'SyncStorageImpl';
  }
};
// FfiConverter for SyncStorage
const FfiConverterTypeSyncStorage = new _uniffiBindgenReactNative.FfiConverterObjectWithCallbacks(uniffiTypeSyncStorageImplObjectFactory);
...
const uniffiCallbackInterfaceSyncStorage = {
  ...
  // ts automatically converts these into C callback functions.
  vtable: {
    addOutgoingChange: (uniffiHandle, record, uniffiFutureCallback, uniffiCallbackData) => {
      const uniffiMakeCall = async signal => {
        const jsCallback = FfiConverterTypeSyncStorage.lift(uniffiHandle);
        return await jsCallback.addOutgoingChange(FfiConverterTypeUnversionedRecordChange.lift(record), {
          signal
        });
      };
      const uniffiHandleSuccess = returnValue => {
        uniffiFutureCallback(uniffiCallbackData, /* UniffiForeignFutureStructU64 */{
          returnValue: _uniffiBindgenReactNative.FfiConverterUInt64.lower(returnValue),
          callStatus: uniffiCaller.createCallStatus()
        });
      };
      const uniffiHandleError = (code, errorBuf) => {
    ...
    completeOutgoingSync: (uniffiHandle, record, uniffiFutureCallback, uniffiCallbackData) => {
      const uniffiMakeCall = async signal => {
        const jsCallback = FfiConverterTypeSyncStorage.lift(uniffiHandle);
        return await jsCallback.completeOutgoingSync(FfiConverterTypeRecord.lift(record), {
          signal
        });
      };
      const uniffiHandleSuccess = returnValue => {
    ...
    getPendingOutgoingChanges: (uniffiHandle, limit, uniffiFutureCallback, uniffiCallbackData) => {
      const uniffiMakeCall = async signal => {
        const jsCallback = FfiConverterTypeSyncStorage.lift(uniffiHandle);
        return await jsCallback.getPendingOutgoingChanges(_uniffiBindgenReactNative.FfiConverterUInt32.lift(limit), {
          signal
        });
      };
      const uniffiHandleSuccess = returnValue => {
    ...
    getLastRevision: (uniffiHandle, uniffiFutureCallback, uniffiCallbackData) => {
      const uniffiMakeCall = async signal => {
        const jsCallback = FfiConverterTypeSyncStorage.lift(uniffiHandle);
        return await jsCallback.getLastRevision({
          signal
        });
      };
      const uniffiHandleSuccess = returnValue => {
    ...
    insertIncomingRecords: (uniffiHandle, records, uniffiFutureCallback, uniffiCallbackData) => {
      const uniffiMakeCall = async signal => {
        const jsCallback = FfiConverterTypeSyncStorage.lift(uniffiHandle);
        return await jsCallback.insertIncomingRecords(FfiConverterArrayTypeRecord.lift(records), {
          signal
        });
      };
      const uniffiHandleSuccess = returnValue => {
    ...
    deleteIncomingRecord: (uniffiHandle, record, uniffiFutureCallback, uniffiCallbackData) => {
      const uniffiMakeCall = async signal => {
        const jsCallback = FfiConverterTypeSyncStorage.lift(uniffiHandle);
        return await jsCallback.deleteIncomingRecord(FfiConverterTypeRecord.lift(record), {
          signal
        });
      };
      const uniffiHandleSuccess = returnValue => {
    ...
    rebasePendingOutgoingRecords: (uniffiHandle, revision, uniffiFutureCallback, uniffiCallbackData) => {
      const uniffiMakeCall = async signal => {
        const jsCallback = FfiConverterTypeSyncStorage.lift(uniffiHandle);
        return await jsCallback.rebasePendingOutgoingRecords(_uniffiBindgenReactNative.FfiConverterUInt64.lift(revision), {
          signal
        });
      };
      const uniffiHandleSuccess = returnValue => {
    ...
    getIncomingRecords: (uniffiHandle, limit, uniffiFutureCallback, uniffiCallbackData) => {
      const uniffiMakeCall = async signal => {
        const jsCallback = FfiConverterTypeSyncStorage.lift(uniffiHandle);
        return await jsCallback.getIncomingRecords(_uniffiBindgenReactNative.FfiConverterUInt32.lift(limit), {
          signal
        });
      };
      const uniffiHandleSuccess = returnValue => {
    ...
    getLatestOutgoingChange: (uniffiHandle, uniffiFutureCallback, uniffiCallbackData) => {
      const uniffiMakeCall = async signal => {
        const jsCallback = FfiConverterTypeSyncStorage.lift(uniffiHandle);
        return await jsCallback.getLatestOutgoingChange({
          signal
        });
      };
      const uniffiHandleSuccess = returnValue => {
        uniffiFutureCallback(uniffiCallbackData, /* UniffiForeignFutureStructRustBuffer */{
          returnValue: FfiConverterOptionalTypeOutgoingChange.lower(returnValue),
          callStatus: uniffiCaller.createCallStatus()
        });
      };
      const uniffiHandleError = (code, errorBuf) => {
    ...
    updateRecordFromIncoming: (uniffiHandle, record, uniffiFutureCallback, uniffiCallbackData) => {
      const uniffiMakeCall = async signal => {
        const jsCallback = FfiConverterTypeSyncStorage.lift(uniffiHandle);
        return await jsCallback.updateRecordFromIncoming(FfiConverterTypeRecord.lift(record), {
          signal
        });
      };
      const uniffiHandleSuccess = returnValue => {
  ...
  register: () => {
    (0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_fn_init_callback_vtable_syncstorage(uniffiCallbackInterfaceSyncStorage.vtable);
  }
};
...
const FfiConverterOptionalTypeOutgoingChange = new _uniffiBindgenReactNative.FfiConverterOptional(FfiConverterTypeOutgoingChange);

// FfiConverter for Record | undefined
const FfiConverterOptionalTypeRecord = new _uniffiBindgenReactNative.FfiConverterOptional(FfiConverterTypeRecord);
...
const FfiConverterArrayTypeIncomingChange = new _uniffiBindgenReactNative.FfiConverterArray(FfiConverterTypeIncomingChange);
...
const FfiConverterArrayTypeOutgoingChange = new _uniffiBindgenReactNative.FfiConverterArray(FfiConverterTypeOutgoingChange);
...
const FfiConverterArrayTypeRecord = new _uniffiBindgenReactNative.FfiConverterArray(FfiConverterTypeRecord);
...
function uniffiEnsureInitialized() {
  ...
  if ((0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_checksum_method_fiatservice_fetch_fiat_currencies() !== 63089) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch('uniffi_breez_sdk_common_checksum_method_fiatservice_fetch_fiat_currencies');
  }
  if ((0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_checksum_method_fiatservice_fetch_fiat_rates() !== 48636) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch('uniffi_breez_sdk_common_checksum_method_fiatservice_fetch_fiat_rates');
  }
  ...
  if ((0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_checksum_method_syncstorage_add_outgoing_change() !== 18302) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch('uniffi_breez_sdk_common_checksum_method_syncstorage_add_outgoing_change');
  }
  if ((0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_checksum_method_syncstorage_complete_outgoing_sync() !== 1608) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch('uniffi_breez_sdk_common_checksum_method_syncstorage_complete_outgoing_sync');
  }
  if ((0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_checksum_method_syncstorage_get_pending_outgoing_changes() !== 43350) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch('uniffi_breez_sdk_common_checksum_method_syncstorage_get_pending_outgoing_changes');
  }
  if ((0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_checksum_method_syncstorage_get_last_revision() !== 11560) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch('uniffi_breez_sdk_common_checksum_method_syncstorage_get_last_revision');
  }
  if ((0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_checksum_method_syncstorage_insert_incoming_records() !== 65359) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch('uniffi_breez_sdk_common_checksum_method_syncstorage_insert_incoming_records');
  }
  if ((0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_checksum_method_syncstorage_delete_incoming_record() !== 6222) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch('uniffi_breez_sdk_common_checksum_method_syncstorage_delete_incoming_record');
  }
  if ((0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_checksum_method_syncstorage_rebase_pending_outgoing_records() !== 49312) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch('uniffi_breez_sdk_common_checksum_method_syncstorage_rebase_pending_outgoing_records');
  }
  if ((0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_checksum_method_syncstorage_get_incoming_records() !== 39529) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch('uniffi_breez_sdk_common_checksum_method_syncstorage_get_incoming_records');
  }
  if ((0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_checksum_method_syncstorage_get_latest_outgoing_change() !== 13979) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch('uniffi_breez_sdk_common_checksum_method_syncstorage_get_latest_outgoing_change');
  }
  if ((0, _breez_sdk_commonFfi.default)().ubrn_uniffi_breez_sdk_common_checksum_method_syncstorage_update_record_from_incoming() !== 63333) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch('uniffi_breez_sdk_common_checksum_method_syncstorage_update_record_from_incoming');
  }
