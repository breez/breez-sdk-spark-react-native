  ...
  class FFIConverter extends _uniffiBindgenReactNative.AbstractFfiConverterByteArray {
    read(from) {
      return {
        ...
        privateEnabledDefault: _uniffiBindgenReactNative.FfiConverterBool.read(from)
      };
    }
    write(value, into) {
 ...
 */
const UpdateUserSettingsRequest = exports.UpdateUserSettingsRequest = (() => {
  const defaults = () => ({});
  const create = (() => {
    return (0, _uniffiBindgenReactNative.uniffiCreateRecord)(defaults);
  })();
 ...
 */
const UserSettings = exports.UserSettings = (() => {
  const defaults = () => ({});
  const create = (() => {
    return (0, _uniffiBindgenReactNative.uniffiCreateRecord)(defaults);
  })();
...
const FfiConverterTypeUserSettings = (() => {
  class FFIConverter extends _uniffiBindgenReactNative.AbstractFfiConverterByteArray {
    read(from) {
      return {
        sparkPrivateModeEnabled: _uniffiBindgenReactNative.FfiConverterBool.read(from)
      };
    }
    write(value, into) {
      _uniffiBindgenReactNative.FfiConverterBool.write(value.sparkPrivateModeEnabled, into);
    }
    allocationSize(value) {
      return _uniffiBindgenReactNative.FfiConverterBool.allocationSize(value.sparkPrivateModeEnabled);
    }
  }
  return new FFIConverter();
})();
...
const SdkEvent = exports.SdkEvent = (() => {
   ...
   */
  class DataSynced_ extends _uniffiBindgenReactNative.UniffiEnum {
    /**
     * @private
     * This field is private and should not be used, use `tag` instead.
     */
   ...
   */
  class UnclaimedDeposits_ extends _uniffiBindgenReactNative.UniffiEnum {
    /**
     * @private
     * This field is private and should not be used, use `tag` instead.
     */
  ...
  class ClaimedDeposits_ extends _uniffiBindgenReactNative.UniffiEnum {
    /**
     * @private
     * This field is private and should not be used, use `tag` instead.
     */
      ...
      switch (ordinalConverter.read(from)) {
        ...
        case 2:
          return new SdkEvent.DataSynced({
            didPullNewRecords: _uniffiBindgenReactNative.FfiConverterBool.read(from)
          });
        case 3:
        ...
        case SdkEvent_Tags.DataSynced:
          {
            ordinalConverter.write(2, into);
            const inner = value.inner;
            _uniffiBindgenReactNative.FfiConverterBool.write(inner.didPullNewRecords, into);
            return;
          }
        ...
        case SdkEvent_Tags.DataSynced:
          {
            const inner = value.inner;
            let size = ordinalConverter.allocationSize(2);
            size += _uniffiBindgenReactNative.FfiConverterBool.allocationSize(inner.didPullNewRecords);
            return size;
          }
        case SdkEvent_Tags.UnclaimedDeposits:
          {
...
class BreezSdk extends _uniffiBindgenReactNative.UniffiAbstractObject {
  ...
  async getUserSettings(asyncOpts_) /*throws*/{
    ...
    try {
      return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return (0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_fn_method_breezsdk_get_user_settings(uniffiTypeBreezSdkObjectFactory.clonePointer(this));
  ...
  async updateUserSettings(request, asyncOpts_) /*throws*/{
    ...
    try {
      return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return (0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_fn_method_breezsdk_update_user_settings(uniffiTypeBreezSdkObjectFactory.clonePointer(this), FfiConverterTypeUpdateUserSettingsRequest.lower(request));
      }, /*pollFunc:*/(0, _breez_sdk_sparkFfi.default)().ubrn_ffi_breez_sdk_spark_rust_future_poll_void, /*cancelFunc:*/(0, _breez_sdk_sparkFfi.default)().ubrn_ffi_breez_sdk_spark_rust_future_cancel_void, /*completeFunc:*/(0, _breez_sdk_sparkFfi.default)().ubrn_ffi_breez_sdk_spark_rust_future_complete_void, /*freeFunc:*/(0, _breez_sdk_sparkFfi.default)().ubrn_ffi_breez_sdk_spark_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_, /*errorHandler:*/FfiConverterTypeSdkError.lift.bind(FfiConverterTypeSdkError));
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
...
class SdkBuilder extends _uniffiBindgenReactNative.UniffiAbstractObject {
  ...
  constructor(config, seed) {
    ...
    const pointer = uniffiCaller.rustCall(/*caller:*/callStatus => {
      return (0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_fn_constructor_sdkbuilder_new(FfiConverterTypeConfig.lower(config), FfiConverterTypeSeed.lower(seed), callStatus);
    }, /*liftString:*/FfiConverterString.lift);
    this[_uniffiBindgenReactNative.pointerLiteralSymbol] = pointer;
  ...
  async withDefaultStorage(storageDir, asyncOpts_) {
    ...
    try {
      return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return (0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_fn_method_sdkbuilder_with_default_storage(uniffiTypeSdkBuilderObjectFactory.clonePointer(this), FfiConverterString.lower(storageDir));
      }, /*pollFunc:*/(0, _breez_sdk_sparkFfi.default)().ubrn_ffi_breez_sdk_spark_rust_future_poll_void, /*cancelFunc:*/(0, _breez_sdk_sparkFfi.default)().ubrn_ffi_breez_sdk_spark_rust_future_cancel_void, /*completeFunc:*/(0, _breez_sdk_sparkFfi.default)().ubrn_ffi_breez_sdk_spark_rust_future_complete_void, /*freeFunc:*/(0, _breez_sdk_sparkFfi.default)().ubrn_ffi_breez_sdk_spark_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_);
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
  ...
  async withRealTimeSyncStorage(storage, asyncOpts_) {
    ...
    try {
      return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return (0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_fn_method_sdkbuilder_with_real_time_sync_storage(uniffiTypeSdkBuilderObjectFactory.clonePointer(this), FfiConverterTypeSyncStorage.lower(storage));
      }, /*pollFunc:*/(0, _breez_sdk_sparkFfi.default)().ubrn_ffi_breez_sdk_spark_rust_future_poll_void, /*cancelFunc:*/(0, _breez_sdk_sparkFfi.default)().ubrn_ffi_breez_sdk_spark_rust_future_cancel_void, /*completeFunc:*/(0, _breez_sdk_sparkFfi.default)().ubrn_ffi_breez_sdk_spark_rust_future_complete_void, /*freeFunc:*/(0, _breez_sdk_sparkFfi.default)().ubrn_ffi_breez_sdk_spark_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_);
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
  ...
  async withStorage(storage, asyncOpts_) {
    ...
    try {
      return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
        return (0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_fn_method_sdkbuilder_with_storage(uniffiTypeSdkBuilderObjectFactory.clonePointer(this), FfiConverterTypeStorage.lower(storage));
      }, /*pollFunc:*/(0, _breez_sdk_sparkFfi.default)().ubrn_ffi_breez_sdk_spark_rust_future_poll_void, /*cancelFunc:*/(0, _breez_sdk_sparkFfi.default)().ubrn_ffi_breez_sdk_spark_rust_future_cancel_void, /*completeFunc:*/(0, _breez_sdk_sparkFfi.default)().ubrn_ffi_breez_sdk_spark_rust_future_complete_void, /*freeFunc:*/(0, _breez_sdk_sparkFfi.default)().ubrn_ffi_breez_sdk_spark_rust_future_free_void, /*liftFunc:*/_v => {}, /*liftString:*/FfiConverterString.lift, /*asyncOpts:*/asyncOpts_);
    } catch (__error) {
      if (uniffiIsDebug && __error instanceof Error) {
        __error.stack = __stack;
...
function uniffiEnsureInitialized() {
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_method_breezsdk_get_user_settings() !== 38537) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch('uniffi_breez_sdk_spark_checksum_method_breezsdk_get_user_settings');
  }
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_method_breezsdk_update_user_settings() !== 1721) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch('uniffi_breez_sdk_spark_checksum_method_breezsdk_update_user_settings');
  }
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_method_sdkbuilder_with_default_storage() !== 14543) {
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_method_sdkbuilder_with_real_time_sync_storage() !== 22382) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch('uniffi_breez_sdk_spark_checksum_method_sdkbuilder_with_real_time_sync_storage');
  }
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_method_sdkbuilder_with_storage() !== 59400) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch('uniffi_breez_sdk_spark_checksum_method_sdkbuilder_with_storage');
  }
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_constructor_sdkbuilder_new() !== 65435) {
