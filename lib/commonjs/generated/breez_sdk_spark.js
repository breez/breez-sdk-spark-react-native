...
async function defaultStorage(dataDir, asyncOpts_) /*throws*/{
  const __stack = uniffiIsDebug ? new Error().stack : undefined;
  try {
    return await (0, _uniffiBindgenReactNative.uniffiRustCallAsync)(/*rustCaller:*/uniffiCaller, /*rustFutureFunc:*/() => {
...
const FfiConverterTypeConfig = (() => {
  class FFIConverter extends _uniffiBindgenReactNative.AbstractFfiConverterByteArray {
    ...
    allocationSize(value) {
      return FfiConverterOptionalString.allocationSize(value.apiKey) + FfiConverterTypeNetwork.allocationSize(value.network) + _uniffiBindgenReactNative.FfiConverterUInt32.allocationSize(value.syncIntervalSecs) + FfiConverterOptionalTypeFee.allocationSize(value.maxDepositClaimFee);
    }
  }
  return new FFIConverter();
})();
      ...
      switch (ordinalConverter.read(from)) {
        ...
        case 2:
          return new SendPaymentOptions.Bolt11Invoice({
            useSpark: _uniffiBindgenReactNative.FfiConverterBool.read(from)
          });
        default:
          throw new _uniffiBindgenReactNative.UniffiInternalError.UnexpectedEnumCase();
      }
        ...
        case SendPaymentOptions_Tags.Bolt11Invoice:
          {
            ordinalConverter.write(2, into);
            const inner = value.inner;
            _uniffiBindgenReactNative.FfiConverterBool.write(inner.useSpark, into);
            return;
          }
        default:
        ...
        case SendPaymentOptions_Tags.Bolt11Invoice:
          {
            const inner = value.inner;
            let size = ordinalConverter.allocationSize(2);
            size += _uniffiBindgenReactNative.FfiConverterBool.allocationSize(inner.useSpark);
            return size;
          }
        default:
          throw new _uniffiBindgenReactNative.UniffiInternalError.UnexpectedEnumCase();
...
class BreezSdk extends _uniffiBindgenReactNative.UniffiAbstractObject {
  ...
  pollLightningSendPayment(paymentId) {
    uniffiCaller.rustCall(/*caller:*/callStatus => {
      (0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_fn_method_breezsdk_poll_lightning_send_payment(uniffiTypeBreezSdkObjectFactory.clonePointer(this), FfiConverterString.lower(paymentId), callStatus);
    }, /*liftString:*/FfiConverterString.lift);
  }
...
class SdkBuilder extends _uniffiBindgenReactNative.UniffiAbstractObject {
  ...
  constructor(config, mnemonic, storage) {
    ...
    const pointer = uniffiCaller.rustCall(/*caller:*/callStatus => {
      return (0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_fn_constructor_sdkbuilder_new(FfiConverterTypeConfig.lower(config), FfiConverterString.lower(mnemonic), FfiConverterTypeStorage.lower(storage), callStatus);
    }, /*liftString:*/FfiConverterString.lift);
    this[_uniffiBindgenReactNative.pointerLiteralSymbol] = pointer;
...
function uniffiEnsureInitialized() {
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_func_default_storage() !== 30804) {
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_method_breezsdk_poll_lightning_send_payment() !== 5478) {
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_method_storage_get_cached_item() !== 11423) {
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_method_storage_set_cached_item() !== 17965) {
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_method_storage_list_payments() !== 55103) {
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_method_storage_insert_payment() !== 35649) {
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_method_storage_set_payment_metadata() !== 780) {
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_method_storage_get_payment_by_id() !== 32084) {
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_method_storage_add_deposit() !== 31647) {
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_method_storage_delete_deposit() !== 19211) {
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_method_storage_list_deposits() !== 11262) {
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_method_storage_update_deposit() !== 58400) {
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_constructor_sdkbuilder_new() !== 52744) {
