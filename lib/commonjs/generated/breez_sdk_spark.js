...
exports.defaultSyncStorage = defaultSyncStorage;
...
function defaultSyncStorage(dataDir) /*throws*/{
  return FfiConverterTypeSyncStorage.lift(uniffiCaller.rustCallWithError(/*liftError:*/FfiConverterTypeSdkError.lift.bind(FfiConverterTypeSdkError), /*caller:*/callStatus => {
    return (0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_fn_func_default_sync_storage(FfiConverterString.lower(dataDir), callStatus);
  }, /*liftString:*/FfiConverterString.lift));
}
...
function uniffiEnsureInitialized() {
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_func_default_sync_storage() !== 62413) {
    throw new _uniffiBindgenReactNative.UniffiInternalError.ApiChecksumMismatch('uniffi_breez_sdk_spark_checksum_func_default_sync_storage');
  }
  ...
  if ((0, _breez_sdk_sparkFfi.default)().ubrn_uniffi_breez_sdk_spark_checksum_method_sdkbuilder_with_real_time_sync_storage() !== 36431) {
