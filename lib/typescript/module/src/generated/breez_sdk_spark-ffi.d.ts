...
type UniffiCallbackInterfaceStorageMethod14 = (uniffiHandle: bigint, record: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteU64, uniffiCallbackData: bigint) => UniffiResult<UniffiForeignFuture>;
type UniffiCallbackInterfaceStorageMethod15 = (uniffiHandle: bigint, record: Uint8Array, localRevision: bigint, uniffiFutureCallback: UniffiForeignFutureCompleteVoid, uniffiCallbackData: bigint) => UniffiResult<UniffiForeignFuture>;
type UniffiCallbackInterfaceStorageMethod16 = (uniffiHandle: bigint, limit: number, uniffiFutureCallback: UniffiForeignFutureCompleteRustBuffer, uniffiCallbackData: bigint) => UniffiResult<UniffiForeignFuture>;
type UniffiCallbackInterfaceStorageMethod17 = (uniffiHandle: bigint, uniffiFutureCallback: UniffiForeignFutureCompleteU64, uniffiCallbackData: bigint) => UniffiResult<UniffiForeignFuture>;
type UniffiCallbackInterfaceStorageMethod18 = (uniffiHandle: bigint, records: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteVoid, uniffiCallbackData: bigint) => UniffiResult<UniffiForeignFuture>;
type UniffiCallbackInterfaceStorageMethod19 = (uniffiHandle: bigint, record: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteVoid, uniffiCallbackData: bigint) => UniffiResult<UniffiForeignFuture>;
...
type UniffiCallbackInterfaceStorageMethod21 = (uniffiHandle: bigint, uniffiFutureCallback: UniffiForeignFutureCompleteRustBuffer, uniffiCallbackData: bigint) => UniffiResult<UniffiForeignFuture>;
type UniffiCallbackInterfaceStorageMethod22 = (uniffiHandle: bigint, record: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteVoid, uniffiCallbackData: bigint) => UniffiResult<UniffiForeignFuture>;
