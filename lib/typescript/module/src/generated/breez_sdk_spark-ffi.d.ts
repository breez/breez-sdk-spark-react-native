...
interface NativeModuleInterface {
    ...
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_ecies_encrypt(ptr: bigint, message: Uint8Array, path: Uint8Array): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_ecies_decrypt(ptr: bigint, message: Uint8Array, path: Uint8Array): bigint;
    ...
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_generate_frost_signing_commitments(ptr: bigint): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_get_public_key_for_node(ptr: bigint, id: Uint8Array): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_generate_random_key(ptr: bigint): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_get_static_deposit_private_key_source(ptr: bigint, index: number): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_get_static_deposit_private_key(ptr: bigint, index: number): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_get_static_deposit_public_key(ptr: bigint, index: number): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_subtract_private_keys(ptr: bigint, signingKey: Uint8Array, newSigningKey: Uint8Array): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_split_secret(ptr: bigint, secret: Uint8Array, threshold: number, numShares: number): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_encrypt_private_key_for_receiver(ptr: bigint, privateKey: Uint8Array, receiverPublicKey: Uint8Array): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_get_public_key_from_private_key_source(ptr: bigint, privateKey: Uint8Array): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_sign_frost(ptr: bigint, request: Uint8Array): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_aggregate_frost_signatures(ptr: bigint, request: Uint8Array): bigint;
    ...
    ubrn_uniffi_breez_sdk_spark_fn_method_storage_set_payment_metadata(ptr: bigint, paymentId: Uint8Array, metadata: Uint8Array): bigint;
    ...
    ubrn_uniffi_breez_sdk_spark_fn_clone_syncstorage(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_free_syncstorage(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_breez_sdk_spark_fn_method_syncstorage_add_outgoing_change(ptr: bigint, record: Uint8Array): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_syncstorage_complete_outgoing_sync(ptr: bigint, record: Uint8Array): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_syncstorage_get_pending_outgoing_changes(ptr: bigint, limit: number): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_syncstorage_get_last_revision(ptr: bigint): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_syncstorage_insert_incoming_records(ptr: bigint, records: Uint8Array): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_syncstorage_delete_incoming_record(ptr: bigint, record: Uint8Array): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_syncstorage_rebase_pending_outgoing_records(ptr: bigint, revision: bigint): bigint;
    ...
    ubrn_uniffi_breez_sdk_spark_fn_init_callback_vtable_syncstorage(vtable: UniffiVTableCallbackInterfaceSyncStorage): void;
...
type UniffiCallbackInterfaceExternalSignerMethod16 = (uniffiHandle: bigint, privateKey: Uint8Array, receiverPublicKey: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteRustBuffer, uniffiCallbackData: bigint) => UniffiResult<UniffiForeignFuture>;
type UniffiCallbackInterfaceExternalSignerMethod17 = (uniffiHandle: bigint, privateKey: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteRustBuffer, uniffiCallbackData: bigint) => UniffiResult<UniffiForeignFuture>;
...
type UniffiCallbackInterfaceStorageMethod8 = (uniffiHandle: bigint, txid: Uint8Array, vout: number, amountSats: bigint, uniffiFutureCallback: UniffiForeignFutureCompleteVoid, uniffiCallbackData: bigint) => UniffiResult<UniffiForeignFuture>;
type UniffiCallbackInterfaceStorageMethod9 = (uniffiHandle: bigint, txid: Uint8Array, vout: number, uniffiFutureCallback: UniffiForeignFutureCompleteVoid, uniffiCallbackData: bigint) => UniffiResult<UniffiForeignFuture>;
type UniffiCallbackInterfaceStorageMethod10 = (uniffiHandle: bigint, uniffiFutureCallback: UniffiForeignFutureCompleteRustBuffer, uniffiCallbackData: bigint) => UniffiResult<UniffiForeignFuture>;
type UniffiCallbackInterfaceStorageMethod11 = (uniffiHandle: bigint, txid: Uint8Array, vout: number, payload: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteVoid, uniffiCallbackData: bigint) => UniffiResult<UniffiForeignFuture>;
type UniffiCallbackInterfaceStorageMethod12 = (uniffiHandle: bigint, metadata: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteVoid, uniffiCallbackData: bigint) => UniffiResult<UniffiForeignFuture>;
