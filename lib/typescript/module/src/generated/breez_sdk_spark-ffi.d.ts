...
interface NativeModuleInterface {
    ...
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_static_deposit_secret_key(ptr: bigint, index: number): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_static_deposit_signing_key(ptr: bigint, index: number): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_subtract_secret_keys(ptr: bigint, signingKey: Uint8Array, newSigningKey: Uint8Array): bigint;
