...
interface NativeModuleInterface {
    ...
    ubrn_uniffi_breez_sdk_spark_fn_method_breezsdk_check_unilateral_exit(ptr: bigint, request: Uint8Array): bigint;
    ...
    ubrn_uniffi_breez_sdk_spark_fn_method_breezsdk_publish_signed_transfer_package(ptr: bigint, request: Uint8Array): bigint;
    ...
    ubrn_uniffi_breez_sdk_spark_fn_method_breezsdk_unilateral_exit(ptr: bigint, request: Uint8Array, signer: bigint): bigint;
    ...
    ubrn_uniffi_breez_sdk_spark_fn_clone_cpfpsigner(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_free_cpfpsigner(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_breez_sdk_spark_fn_init_callback_vtable_cpfpsigner(vtable: UniffiVTableCallbackInterfaceCpfpSigner): void;
    ubrn_uniffi_breez_sdk_spark_fn_method_cpfpsigner_sign_psbt(ptr: bigint, psbtBytes: Uint8Array): bigint;
    ...
    ubrn_uniffi_breez_sdk_spark_fn_clone_externalsigningsigner(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_free_externalsigningsigner(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): void;
    ubrn_uniffi_breez_sdk_spark_fn_init_callback_vtable_externalsigningsigner(vtable: UniffiVTableCallbackInterfaceExternalSigningSigner): void;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigningsigner_derive_public_key(ptr: bigint, path: Uint8Array): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigningsigner_sign_ecdsa(ptr: bigint, message: Uint8Array, path: Uint8Array): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigningsigner_sign_ecdsa_recoverable(ptr: bigint, message: Uint8Array, path: Uint8Array): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigningsigner_sign_hash_schnorr(ptr: bigint, hash: Uint8Array, path: Uint8Array): bigint;
    ...
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsparksigner_is_remote(ptr: bigint, uniffi_out_err: UniffiRustCallStatus): number;
    ...
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsparksigner_sign_leaf_refund_spend(ptr: bigint, leafId: Uint8Array, sighash: Uint8Array): bigint;
    ...
    ubrn_uniffi_breez_sdk_spark_fn_constructor_sdkbuilder_new_with_signing_only_signer(config: Uint8Array, breezSigner: bigint, sparkSigner: bigint, uniffi_out_err: UniffiRustCallStatus): bigint;
    ...
    ubrn_uniffi_breez_sdk_spark_fn_method_sdkbuilder_with_session_store(ptr: bigint, sessionStore: bigint): bigint;
    ...
    ubrn_uniffi_breez_sdk_spark_fn_func_connect_with_signing_only_signer(request: Uint8Array): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_func_create_turnkey_signer(config: Uint8Array): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_func_create_turnkey_signing_only_signer(config: Uint8Array): bigint;
    ...
    ubrn_uniffi_internal_fn_method_cpfpsigner_ffi__bless_pointer(pointer: bigint, uniffi_out_err: UniffiRustCallStatus): UniffiRustArcPtr;
    ...
    ubrn_uniffi_internal_fn_method_externalsigningsigner_ffi__bless_pointer(pointer: bigint, uniffi_out_err: UniffiRustCallStatus): UniffiRustArcPtr;
...
type UniffiCallbackInterfaceExternalSigningSignerMethod0 = (uniffiHandle: bigint, path: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteRustBuffer, uniffiCallbackData: bigint) => UniffiForeignFuture;
type UniffiCallbackInterfaceExternalSigningSignerMethod1 = (uniffiHandle: bigint, message: Uint8Array, path: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteRustBuffer, uniffiCallbackData: bigint) => UniffiForeignFuture;
type UniffiCallbackInterfaceExternalSigningSignerMethod2 = (uniffiHandle: bigint, message: Uint8Array, path: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteRustBuffer, uniffiCallbackData: bigint) => UniffiForeignFuture;
type UniffiCallbackInterfaceExternalSigningSignerMethod3 = (uniffiHandle: bigint, hash: Uint8Array, path: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteRustBuffer, uniffiCallbackData: bigint) => UniffiForeignFuture;
...
type UniffiCallbackInterfaceExternalSparkSignerMethod2 = (uniffiHandle: bigint) => UniffiResult<number>;
type UniffiCallbackInterfaceExternalSparkSignerMethod3 = (uniffiHandle: bigint, index: number, uniffiFutureCallback: UniffiForeignFutureCompleteRustBuffer, uniffiCallbackData: bigint) => UniffiForeignFuture;
type UniffiCallbackInterfaceExternalSparkSignerMethod4 = (uniffiHandle: bigint, challenge: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteRustBuffer, uniffiCallbackData: bigint) => UniffiForeignFuture;
type UniffiCallbackInterfaceExternalSparkSignerMethod5 = (uniffiHandle: bigint, message: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteRustBuffer, uniffiCallbackData: bigint) => UniffiForeignFuture;
type UniffiCallbackInterfaceExternalSparkSignerMethod6 = (uniffiHandle: bigint, leafId: Uint8Array, sighash: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteRustBuffer, uniffiCallbackData: bigint) => UniffiForeignFuture;
type UniffiCallbackInterfaceExternalSparkSignerMethod7 = (uniffiHandle: bigint, jobs: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteRustBuffer, uniffiCallbackData: bigint) => UniffiForeignFuture;
...
type UniffiCallbackInterfaceExternalSparkSignerMethod15 = (uniffiHandle: bigint, request: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteRustBuffer, uniffiCallbackData: bigint) => UniffiForeignFuture;
type UniffiCallbackInterfaceExternalSparkSignerMethod16 = (uniffiHandle: bigint, request: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteRustBuffer, uniffiCallbackData: bigint) => UniffiForeignFuture;
