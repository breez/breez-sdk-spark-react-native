...
interface NativeModuleInterface {
    ...
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_static_deposit_secret_key_encrypted(ptr: bigint, index: number): bigint;
    ...
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_encrypt_secret_key_for_receiver(ptr: bigint, secretKey: Uint8Array, receiverPublicKey: Uint8Array): bigint;
    ubrn_uniffi_breez_sdk_spark_fn_method_externalsigner_public_key_from_secret_key_source(ptr: bigint, secretKey: Uint8Array): bigint;
...
type UniffiCallbackInterfaceExternalSignerMethod16 = (uniffiHandle: bigint, secretKey: Uint8Array, receiverPublicKey: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteRustBuffer, uniffiCallbackData: bigint) => UniffiResult<UniffiForeignFuture>;
type UniffiCallbackInterfaceExternalSignerMethod17 = (uniffiHandle: bigint, secretKey: Uint8Array, uniffiFutureCallback: UniffiForeignFutureCompleteRustBuffer, uniffiCallbackData: bigint) => UniffiResult<UniffiForeignFuture>;
